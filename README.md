...
This is a template for mods, that use more convenient directory style for source files. Instead of dumping all files into `Classes` folder, you make a directory `sources`
